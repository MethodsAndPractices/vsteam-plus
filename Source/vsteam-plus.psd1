## Module manifest for module 'vsteam-plus'
#
# Generated by: @DonovanBrown
#
# Generated on: 07/14/2020
#
# .ExternalHelp vsteam-plus-Help.xml

@{

   # Script module or binary module file associated with this manifest.
   RootModule           = 'vsteam-plus.psm1'
   ...
   GUID                 = '9c994f3e-0c64-401c-a8ce-f951cafab33e'
   ...
   RequiredModules      = @('VSTeam', 'SHiPS', 'Trackyon.Utils')
   ...
   TypesToProcess       = @('.\vsteam-plus.types.ps1xml')

   # Format files (.ps1xml) to be loaded when importing this module
   FormatsToProcess     = @('.\vsteam-plus.format.ps1xml')
   ...
   PrivateData          = @{
      ...
      PSData = @{
         ...
         # automatically when vsteam-plus is installed.
         # ExternalModuleDependencies = @('SHiPS')

         # A URL to the license for this module.
         LicenseUri   = 'https://github.com/MethodsAndPractices/vsteam/blob/master/LICENSE'
         ...
         ReleaseNotes = 'https://github.com/MethodsAndPractices/vsteam/blob/master/CHANGELOG.md'
